  ...
  return (
    <div className="mt-16 max-w-4xl mx-auto space-y-12 text-gray-700 leading-relaxed">
      ...
      <section className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
        <h2 className="text-2xl font-bold text-red-800 mb-6">Guia Rápido: Como usar este Simulador</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="flex flex-col items-center text-center p-4 border rounded-xl bg-slate-50">
            <span className="w-10 h-10 bg-red-800 text-white rounded-full flex items-center justify-center font-bold mb-3 shadow-md">1</span>
            <p className="text-sm font-medium">Insira o <span className="font-bold">valor inicial</span> disponível para começar.</p>
          </div>
          <div className="flex flex-col items-center text-center p-4 border rounded-xl bg-slate-50">
            <span className="w-10 h-10 bg-red-800 text-white rounded-full flex items-center justify-center font-bold mb-3 shadow-md">2</span>
            <p className="text-sm font-medium">Defina o <span className="font-bold">aporte mensal</span> que você fará.</p>
          </div>
          <div className="flex flex-col items-center text-center p-4 border rounded-xl bg-slate-50">
            <span className="w-10 h-10 bg-red-800 text-white rounded-full flex items-center justify-center font-bold mb-3 shadow-md">3</span>
            <p className="text-sm font-medium">Informe a <span className="font-bold">taxa de rentabilidade</span> (anual ou mensal).</p>
          </div>
          <div className="flex flex-col items-center text-center p-4 border rounded-xl bg-slate-50">
            <span className="w-10 h-10 bg-red-800 text-white rounded-full flex items-center justify-center font-bold mb-3 shadow-md">4</span>
            <p className="text-sm font-medium">Escolha o <span className="font-bold">tempo total</span> da aplicação.</p>
          </div>
          <div className="flex flex-col items-center text-center p-4 border rounded-xl bg-slate-50">
            <span className="w-10 h-10 bg-red-800 text-white rounded-full flex items-center justify-center font-bold mb-3 shadow-md">5</span>
            <p className="text-sm font-medium">Clique em <span className="font-bold text-red-800">Calcular</span> e veja a mágica acontecer!</p>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="bg-gray-100 p-8 rounded-xl text-center my-6">
          <span className="text-3xl font-serif italic text-red-900">M = C (1 + i) <sup>t</sup></span>
        </div>
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-6 bg-red-50 rounded-xl border border-red-100">
            <h4 className="font-bold text-red-800 mb-2">Dívidas</h4>
